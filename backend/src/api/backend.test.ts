...
describe('createBackend delegation:', () => {
  ...
  const commandCases: Array<[string, unknown[]]> = [
    ...
    ['signPlayer', ['player-7']],
    ['refreshTransfers', []],
    ['buildWing', ['medical', 'rehabGym']],
    ['demolishWing', ['medical', 'rehabGym']],
    ['setWingMode', ['medical', 'rehabGym', 'core_staff']],
    ['setWingStaffTier', ['medical', 'rehabGym', 3]],
    ['mothballWing', ['medical', 'rehabGym']],
    ['unmothballWing', ['medical', 'rehabGym']],
