import { NameGenerator, type Gender, type Country } from './name-generator.js';
import { type Player, type PlayerAttributes, type Position } from '../shared/types.js';
import { v4 as uuidv4 } from '../shared/uuid.js';
